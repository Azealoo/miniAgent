...
def list_session_files_workspace_items(
    *,
    ...
    observed = _collect_session_artifacts(messages)
    ...
    for message in messages:
        ...
        for tool_call in tool_calls:
            ...
            for artifact_ref in artifact_refs:
                ...
                artifact_path_run_id = _artifact_path_run_id(artifact_path)

                observe(
                    path=artifact_path,
                    artifact_type=_clean_text(artifact_ref.get("artifact_type")),
                    run_id=artifact_run_id or artifact_path_run_id,
...
def _artifact_path_run_id(path: str | None) -> str | None:
    normalized_path = _clean_path(path)
